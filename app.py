...
driver.get('https://bmail.uol.com.br/?xc=26264ffb5c818fe37ae1766d03e2b735#/webmail/0//INBOX/page:1')
...
existe = False
try:
    selected_email = driver.find_element(By.XPATH,'/html/body/div[3]/div/section[2]/div/div[2]/div/div[2]/section[1]/div/div[5]/ul/li[1]/a/div/div[3]/span')
    time.sleep(2)
...
for email in range(101):
    try:
        encaminhar = driver.find_element(By.XPATH, '/html/body/div[3]/div/section[2]/div/div[2]/div/div[2]/section[2]/div/div[1]/div[1]/menu[3]/span[2]')
        encaminhar.click()
        time.sleep(3)
        destino = driver.find_element(By.ID, 'fake_input__field-to')
        destino.send_keys(enc_para)
        time.sleep(5)
        btn_enviar = driver.find_element(By.XPATH, '/html/body/div[3]/div/div[1]/div[1]/form/div[4]/menu[1]/span[2]')
        btn_enviar.click()
        time.sleep(2)
        btn_apagar = driver.find_element(By.XPATH, '/html/body/div[3]/div/section[2]/div/div[2]/div/div[1]/div[1]/span/ul/li[2]/span/span')
        btn_apagar.click()
        time.sleep(3)
        total_envio +=1
    except common.exceptions.NoSuchElementException:
        back_entrada = driver.find_element(By.XPATH, "//*[@id='fc-collapsable-sidebar']/div[3]/div[2]/div/div[1]/ul/li[1]")
        back_entrada.click()
        break
    else:
        print('')
